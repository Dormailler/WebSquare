/*amd /page/P00075.xml 4521 a431bdc2f9436fb61645cc64fd8057c381b1dc455f3ad5938d073d4b9e1349c5 */
define({declaration:{A:{version:'1.0',encoding:'UTF-8'}},E:[{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',A:{},E:[{T:1,N:'w2:historyInfo',E:[{T:1,N:'w2:history',A:{}}]},{T:1,N:'w2:type',E:[{T:3,text:'COMPONENT'}]},{T:1,N:'w2:buildDate'},{T:1,N:'w2:MSA'},{T:1,N:'xf:model',E:[{T:1,N:'w2:dataCollection',A:{baseNode:'map'},E:[{T:1,N:'w2:dataList',A:{baseNode:'list',repeatNode:'map',id:'dlt_holiday',saveRemovedData:'true'},E:[{T:1,N:'w2:columnInfo',E:[{T:1,N:'w2:column',A:{id:'holiday',name:'휴일',dataType:'text'}}]},{T:1,N:'w2:data',A:{use:'true'},E:[{T:1,N:'w2:row',E:[{T:1,N:'holiday',E:[{T:4,cdata:'*0101'}]}]},{T:1,N:'w2:row',E:[{T:1,N:'holiday',E:[{T:4,cdata:'*0301'}]}]},{T:1,N:'w2:row',E:[{T:1,N:'holiday',E:[{T:4,cdata:'*0505'}]}]},{T:1,N:'w2:row',E:[{T:1,N:'holiday',E:[{T:4,cdata:'*0606'}]}]},{T:1,N:'w2:row',E:[{T:1,N:'holiday',E:[{T:4,cdata:'*0815'}]}]},{T:1,N:'w2:row',E:[{T:1,N:'holiday',E:[{T:4,cdata:'*1003'}]}]},{T:1,N:'w2:row',E:[{T:1,N:'holiday',E:[{T:4,cdata:'*1009'}]}]},{T:1,N:'w2:row',E:[{T:1,N:'holiday',E:[{T:4,cdata:'*1225'}]}]}]}]}]},{T:1,N:'w2:workflowCollection'}]},{T:1,N:'w2:layoutInfo'},{T:1,N:'w2:publicInfo',A:{method:''}},{T:1,N:'script',A:{lazy:'false',type:'text/javascript'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){
