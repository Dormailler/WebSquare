/*amd /ex/WC2.xml 3761 51578b2246818b6448d5b489420a531c7ccc71385fab65dfddae58c66cd3202b */
...
}}}]},{T:1,N:'style',A:{type:'text/css'},E:[{T:4,cdata:'.w2window_selected{border:10px solid green}'}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload'},E:[{T:1,N:'w2:windowContainer',A:{id:'wc1',style:'position: relative;width: 700px;height: 400px;',useFixButton:'true',closeType:'noneFixedWindow',useWindowScrollButton:'true',nameLayerRearrange:'true',windowMoveType:'overflow'},E:[{T:1,N:'w2:windowToolbar',E:[{T:1,N:'w2:controlIconLayer',E:[{T:1,N:'w2:controlIcon'},{T:1,N:'w2:controlIcon'},{T:1,N:'w2:controlIcon'},{T:1,N:'w2:controlIcon'},{T:1,N:'w2:controlIcon'}]},{T:1,N:'w2:nameLayer'},{T:1,N:'w2:selectedNameLayer'}]}]},{T:1,N:'xf:trigger',A:{type:'button',id:'trigger1',style:'width: 80px;height: 23px;','ev:onclick':'scwin.trigger1_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'생성'}]}]},{T:1,N:'xf:trigger',A:{type:'button',id:'trigger2',style:'width: 80px;height: 23px;','ev:onclick':'scwin.trigger2_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'고정'}]}]},{T:1,N:'xf:trigger',A:{type:'button',id:'trigger3',style:'width: 80px;height: 23px;','ev:onclick':'scwin.trigger3_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'고정 취소'}]}]},{T:1,N:'xf:trigger',A:{type:'button',id:'trigger4',style:'width: 80px;height: 23px;','ev:onclick':'scwin.trigger4_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'고정 생성'}]}]},{T:1,N:'xf:trigger',A:{type:'button',id:'trigger5',style:'width:141px;height:23px;','ev:onclick':'scwin.trigger5_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'크기 생성(600X300)'}]}]},{T:1,N:'xf:trigger',A:{type:'button',id:'trigger6',style:'width:126px;height:23px;','ev:onclick':'scwin.trigger6_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'크기 생성(200X200)'}]}]}]}]}]})