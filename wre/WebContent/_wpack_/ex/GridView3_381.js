/*amd /ex/GridView3_381.xml 6552 14cc424942939d34660ac3b4e9de4a64f6fce7a02296a9eb9fd74fc3a455aecf */
...
scwin.trigger3_onclick = function(e) { // 실제인덱스사용 false 현재
    gv1.setRowBackgroundColor(0,"green",false);
};

}}}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload'},E:[{T:1,N:'w2:gridView',A:{checkAllType:'false',defaultCellHeight:'20',id:'gv1',style:'width:500px;height:309px;',dataList:'data:dataList1',groupbyZone:'true',groupbyZoneHeight:'80',groupbyZoneMessage:'그룹존',groupbyFilterBox:'true',groupbyFilterBoxLocation:'top',useFilterList:'true',customFilterBox:'true',copyType:'default',useShiftKey:'true'},E:[{T:1,N:'w2:caption',A:{style:'',id:'caption2',value:'this is a grid caption.'}},{T:1,N:'w2:header',A:{style:'',id:'header2'},E:[{T:1,N:'w2:row',A:{style:'',id:'row3'},E:[{T:1,N:'w2:column',A:{width:'70',inputType:'text',style:'',id:'column6',value:'name1',displayMode:'label',useFilter:'true'}},{T:1,N:'w2:column',A:{width:'70',inputType:'text',style:'',id:'column5',value:'name2',displayMode:'label',useFilter:'true'}},{T:1,N:'w2:column',A:{width:'70',inputType:'text',style:'',id:'column4',value:'name3',displayMode:'label',useFilter:'true'}},{T:1,N:'w2:column',A:{width:'70',inputType:'text',style:'',id:'column3',value:'name4',displayMode:'label',useFilter:'true'}}]}]},{T:1,N:'w2:gBody',A:{style:'',id:'gBody2'},E:[{T:1,N:'w2:row',A:{style:'',id:'row4'},E:[{T:1,N:'w2:column',A:{width:'70',inputType:'select',style:'',id:'col1',value:'',displayMode:'label delim value',allOption:'',chooseOption:'',ref:''},E:[{T:1,N:'w2:choices',E:[{T:1,N:'w2:itemset',A:{nodeset:'data:dataList2'},E:[{T:1,N:'w2:label',A:{ref:'col1'}},{T:1,N:'w2:value',A:{ref:'col2'}}]}]}]},{T:1,N:'w2:column',A:{width:'70',inputType:'autoComplete',style:'',id:'col2',value:'',displayMode:'label',viewType:'icon',viewTypeIconImage:'true',directOpen:'true',allOption:'',chooseOption:'',ref:''},E:[{T:1,N:'w2:choices',E:[{T:1,N:'w2:itemset',A:{nodeset:'data:dataList2'},E:[{T:1,N:'w2:label',A:{ref:'col1'}},{T:1,N:'w2:value',A:{ref:'col2'}}]}]}]},{T:1,N:'w2:column',A:{width:'70',inputType:'text',style:'',id:'col3',value:'',displayMode:'label'}},{T:1,N:'w2:column',A:{width:'70',inputType:'text',style:'',id:'col4',value:'',displayMode:'label'}}]}]}]},{T:1,N:'xf:trigger',A:{type:'button',id:'trigger2',style:'width: 80px;height: 23px;','ev:onclick':'scwin.trigger2_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'행추가'}]}]},{T:1,N:'xf:trigger',A:{type:'button',id:'trigger1',style:'width:172px;height:23px;','ev:onclick':'scwin.trigger1_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'groupby()-필터링'}]}]},{T:1,N:'xf:trigger',A:{type:'button',id:'trigger3',style:'width:157px;height:23px;','ev:onclick':'scwin.trigger3_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'setRowBackGround'}]}]}]}]}]})