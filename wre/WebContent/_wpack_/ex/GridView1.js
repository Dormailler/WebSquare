/*amd /ex/GridView1.xml 14816 789948c32397aafe53de7d468bca2509bbc8e7c641271cb397b9f83b8770826d */
define({declaration:{A:{version:'1.0',encoding:'UTF-8'}},E:[{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',E:[{T:1,N:'w2:type',E:[{T:3,text:'COMPONENT'}]},{T:1,N:'w2:buildDate'},{T:1,N:'w2:MSA'},{T:1,N:'xf:model',E:[{T:1,N:'w2:dataCollection',A:{baseNode:'map'},E:[{T:1,N:'w2:dataList',A:{baseNode:'list',repeatNode:'map',id:'dataList1',saveRemovedData:'true'},E:[{T:1,N:'w2:columnInfo',E:[{T:1,N:'w2:column',A:{id:'col1',name:'name1',dataType:'text'}},{T:1,N:'w2:column',A:{id:'col2',name:'name2',dataType:'text'}},{T:1,N:'w2:column',A:{id:'col3',name:'name3',dataType:'text'}}]},{T:1,N:'w2:data',A:{use:'true'},E:[{T:1,N:'w2:row',E:[{T:1,N:'col1',E:[{T:4,cdata:'1'}]},{T:1,N:'col2',E:[{T:4,cdata:'1000'}]},{T:1,N:'col3',E:[{T:4,cdata:'21'}]}]},{T:1,N:'w2:row',E:[{T:1,N:'col2',E:[{T:4,cdata:'2000'}]},{T:1,N:'col1',E:[{T:4,cdata:'2'}]},{T:1,N:'col3',E:[{T:4,cdata:'215'}]}]},{T:1,N:'w2:row',E:[{T:1,N:'col1',E:[{T:4,cdata:'3'}]},{T:1,N:'col2',E:[{T:4,cdata:'40000'}]},{T:1,N:'col3',E:[{T:4,cdata:'25125'}]}]},{T:1,N:'w2:row',E:[{T:1,N:'col1',E:[{T:4,cdata:'3'}]},{T:1,N:'col3',E:[{T:4,cdata:'215'}]},{T:1,N:'col2',E:[{T:4,cdata:'12313'}]}]},{T:1,N:'w2:row',E:[{T:1,N:'col1',E:[{T:4,cdata:'11'}]},{T:1,N:'col2',E:[{T:4,cdata:'325235'}]},{T:1,N:'col3',E:[{T:4,cdata:'2151'}]}]},{T:1,N:'w2:row',E:[{T:1,N:'col3',E:[{T:4,cdata:'21'}]},{T:1,N:'col2',E:[{T:4,cdata:'342525'}]},{T:1,N:'col1',E:[{T:4,cdata:'11'}]}]}]}]},{T:1,N:'w2:dataList',A:{baseNode:'list',repeatNode:'map',id:'dataList2',saveRemovedData:'true'},E:[{T:1,N:'w2:columnInfo',E:[{T:1,N:'w2:column',A:{id:'col1',name:'name1',dataType:'text'}},{T:1,N:'w2:column',A:{id:'col2',name:'name2',dataType:'text'}},{T:1,N:'w2:column',A:{id:'col3',name:'name3',dataType:'text'}},{T:1,N:'w2:column',A:{id:'col4',name:'name4',dataType:'text'}},{T:1,N:'w2:column',A:{id:'col5',name:'name5',dataType:'text'}},{T:1,N:'w2:column',A:{id:'col6',name:'name6',dataType:'text'}},{T:1,N:'w2:column',A:{id:'col7',name:'name7',dataType:'text'}},{T:1,N:'w2:column',A:{id:'col8',name:'name8',dataType:'text'}}]}]},{T:1,N:'w2:dataList',A:{baseNode:'list',id:'dataList3',repeatNode:'map',saveRemovedData:'true',style:''},E:[{T:1,N:'w2:columnInfo',E:[{T:1,N:'w2:column',A:{dataType:'text',id:'col1',name:'name1'}},{T:1,N:'w2:column',A:{dataType:'text',id:'col2',name:'name2'}},{T:1,N:'w2:column',A:{dataType:'text',id:'col3',name:'name3'}}]},{T:1,N:'w2:data',A:{use:'false'},E:[{T:1,N:'w2:row',E:[{T:1,N:'col1',E:[{T:4,cdata:'1'}]},{T:1,N:'col2',E:[{T:4,cdata:'1000'}]},{T:1,N:'col3',E:[{T:4,cdata:'21'}]}]},{T:1,N:'w2:row',E:[{T:1,N:'col2',E:[{T:4,cdata:'2000'}]},{T:1,N:'col1',E:[{T:4,cdata:'2'}]},{T:1,N:'col3',E:[{T:4,cdata:'215'}]}]},{T:1,N:'w2:row',E:[{T:1,N:'col1',E:[{T:4,cdata:'3'}]},{T:1,N:'col2',E:[{T:4,cdata:'40000'}]},{T:1,N:'col3',E:[{T:4,cdata:'25125'}]}]},{T:1,N:'w2:row',E:[{T:1,N:'col1',E:[{T:4,cdata:'3'}]},{T:1,N:'col3',E:[{T:4,cdata:'215'}]},{T:1,N:'col2',E:[{T:4,cdata:'12313'}]}]},{T:1,N:'w2:row',E:[{T:1,N:'col1',E:[{T:4,cdata:'11'}]},{T:1,N:'col2',E:[{T:4,cdata:'325235'}]},{T:1,N:'col3',E:[{T:4,cdata:'2151'}]}]},{T:1,N:'w2:row',E:[{T:1,N:'col3',E:[{T:4,cdata:'21'}]},{T:1,N:'col2',E:[{T:4,cdata:'342525'}]},{T:1,N:'col1',E:[{T:4,cdata:'11'}]}]}]}]}]},{T:1,N:'w2:workflowCollection'}]},{T:1,N:'w2:layoutInfo'},{T:1,N:'w2:publicInfo',A:{method:''}},{T:1,N:'script',A:{lazy:'false',type:'text/javascript'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){
scwin.onpageload = function() {
	scwin.trigger1_onclick = function(e) {
    var opt = {
        // type : 0 - value 1 - label
        // convertIndex type설정 반대로 올릴 컬럼명시
        // decimal: 3 -> 4째 자리에서 반올림  applyDecimal이 1이여야함
        "headerExist":1,
        "dateFormat":"MM-DD-yyyy"
        // trim : 1 -> 공백제거
        // sheetName: "sheet1" // 업로드할 시트지정
        // wframe: true
        // name: "업로드"
        // features: "top=20,left=20,width=500,height=200" 크기,위치조정
        // className: "style" // 임의클래스지정
        // resizable: false
        // windowDragMove : true
        };
...
scwin.trigger12_onclick = function(e) {
    var opt = {
        // useSubTotal:True,
        // xxxFontBold:True - header,body,subTotal,footer
        // useStyle:true - 바꾼 css 유지해서 다운
        // colMerge:"true";
        // colMergeValue:"true"
    };
    opt.headerColor = "pink";
